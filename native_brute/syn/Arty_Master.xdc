...
set_property -dict { PACKAGE_PIN H5    IOSTANDARD LVCMOS33 } [get_ports { status_led }]; #IO_L24N_T3_35 Sch=led[4]
...
set_property -dict { PACKAGE_PIN C2    IOSTANDARD LVCMOS33 } [get_ports { rst_in }]; #IO_L16P_T2_35 Sch=ck_rst
